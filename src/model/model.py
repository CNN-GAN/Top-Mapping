...
class Net(object):
    ...
    def test(self, args):
        ...
        test_dir = ["T1", "T2", "T3", "T4", "T5", "T6", "T7", "T8", "T9", "T10"]
    ...
    def loadParam(self, args):
        ...
        if self.model == 'ALI_CLC':
            if args.is_train == True:
                ...
                load_dZ = tl.files.load_npz(path=args.checkpoint_dir, name='/net_dZ_%d00.npz' % args.c_epoch)
